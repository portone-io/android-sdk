...
data class NiceV2PaymentBypass(
     ...
     */
    val directCouponYn: NiceV2DirectCoupon? = null,
    /**
     * 다이렉트 호출 결제 수단 (BANK: 계좌이체/CELLPHONE: 휴대폰 소액결제)
     */
    val directShowOpt: NiceV2DirectShow? = null,
    /**
     * 카드사 별 호출 방식
     * 
     ...
     */
    val cardShowOpt: String? = null,
    /**
     * 페이코 계정 자동 로그인 기능 사용하기 위해 페이코에서 고객사에 발급한 ClientId
     */
    val paycoClientId: String? = null,
    /**
     * 페이코 계정 자동 로그인 기능 사용을 위한 접속 토큰
     */
    val paycoAccessToken: String? = null,
    /**
     * 삼성페이 고객사 유형 (01: 삼성페이 內 쇼핑 / 99: 기타 (기본값))
     */
    val samPayMallType: NiceV2SamPayMallType? = null
) : Parcelable {
